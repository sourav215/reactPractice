...
5. What is meant by callback function? What is its purpose?
   ...
   function.
6. Explain the term high order component
...
12. What is React State?
    ...
    component.
13. How can you update state in react js?
    A state can be updated on the component directly or indirectly.
14. Explain the use of the arrow function in React
...
15. State the main difference between Pros and State
    The main difference the two is that the State is mutable and Pros are immutable.
16. Explain pure components in React js
    ...
    application.
17. What kind of information controls a segment in React?
...
22. What is the use of empty tags ?
...
27. What is Babel in React js?
    ...
    7 | P a g e
28. How can a browser read JSX file?
...
29. What are the major issues of using MVC architecture in React?
...
33. When should you use the top-class elements for the function element?
    If your element does a stage or lifetime cycle, we should use top-class elements.
34. How can you share an element in the parsing?
    Using the State, we can share the data.
35. Explain the term reconciliation
    ...
    8 | P a g e
36. How can you re-render a component without using setState() function?
    You can use forceUpdate() function for re-rending any component.
37. Can you update props in react?
...
38. Explain the term 'Restructuring.'
...
39. Can you update the values of props?
    It is not possible to update the value of props as it is immutable.
40. Explain the meaning of Mounting and Demounting
